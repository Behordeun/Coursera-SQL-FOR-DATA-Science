...
SELECT *
FROM Customers c
WHERE c.CustomerId OR c.FirstName OR c.LastName OR c.Company
OR c.Address OR c.City OR c.State OR c.Country OR c.PostalCode
OR c.Phone OR c.Fax OR c.Email OR c.SupportRepId
IS NULL;
